...
testing = ['addition', 'minus', 'multiplication', 
           'division', 'minimum', 'power', 'factorial']
opr = "+-*/%^!"
for op in range(7):
    ...
    for i in tqdm(range(10)):
        ...
        if op == 0:
            ...
            ans = factorial(a)
            b = 0
        p = subprocess.Popen(['image/bin/jupiter', 'r10625016.s'], stdin=PIPE, stdout=PIPE, stderr=PIPE)
